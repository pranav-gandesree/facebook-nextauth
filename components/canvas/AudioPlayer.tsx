...
const AudioPlayer: React.FC = () => {
  ...
  const [lastVisualizerData, setLastVisualizerData] = useState<Uint8Array | null>(null);
  ...
  const animateDefault = (ctx: CanvasRenderingContext2D, canvas: HTMLCanvasElement, time: number) => {
